...
from .base_config import base_config, save_processor, auc_selection, data_dir
from glioma_prediction.extract_sensitivity_split import extract_sensitivity_split

n_hidden_layers = 5

# Fixed at the values selected by the main glioma h_reg/o_reg grid search
# (pnet.py)
SELECTED_H_REG = 1e-3
SELECTED_O_REG = 1e-2
...
_run_dir = os.path.join("glioma_prediction", "runs", "pnet_hyperparameter_sensitivity")
