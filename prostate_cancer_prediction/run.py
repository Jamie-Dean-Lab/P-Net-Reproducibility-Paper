...
from prostate_cancer_prediction.plotting.plot_external_validation_elmarakeby import \
    plot_external_validation as plot_external_validation_elmarakeby
...
def run():
    ...
    # Feature-importance stability across different test-train splits
    analyse_importance_stability(
        run_dir, figures_dir, n_hidden_layers,
