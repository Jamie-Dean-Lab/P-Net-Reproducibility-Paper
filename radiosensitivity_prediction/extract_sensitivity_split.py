...
(outer_kfolds=5, tt_split_seed=42) and saves them to data/sensitivity_split_fold0.json.
"""

import json
import os

from radiosensitivity_prediction.configs.base_config import base_config, data_dir
